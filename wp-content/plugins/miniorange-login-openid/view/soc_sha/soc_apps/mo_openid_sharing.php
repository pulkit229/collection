...
<form id="social_share" name="social_share" method="post" action="">
        ...
        <table style="width: 100%;">
            <tr id="sel_apps">
                <td><h3 ><?php echo mo_sl('Select Social Apps');?> </h3>
                    <table style="width: 100%">
                        <p style="font-size: 17px;"><?php echo mo_sl('Select applications to enable social sharing');?></p>
                        <tr>
                        ...
                        <tr>
                            ...
                            <td style="width:20%">
                                ...
                                <label class="mo_openid_checkbox_container"><?php echo mo_sl('Facebook');?>
                            ...
                            <td style="width:20%">
                                <label class="mo_openid_checkbox_container"><?php echo mo_sl('Twitter');?>.
                                    <input type="checkbox"
                            ...
                            <td style="width:20%">
                                ...
                                <label class="mo_openid_checkbox_container"><?php echo mo_sl('Google');?>
                            ...
                            <td style="width:20%">
                                ...
                                <label class="mo_openid_checkbox_container"><?php echo mo_sl('Tumblr');?>
                                    <input type="checkbox"
                        ...
                        <tr>
                            <td style="width:20%">
                                ...
                                <label class="mo_openid_checkbox_container"><?php echo mo_sl('StumbleUpon');?>
                            ...
                            <td style="width:20%">
                                ...
                                <label class="mo_openid_checkbox_container"><?php echo mo_sl('LinkedIn');?>
                            ...
                            <td style="width:20%">
                                ...
                                <label class="mo_openid_checkbox_container"><?php echo mo_sl('Pinterest');?>
                            ...
                            <td style="width:20%">
                                ...
                                <label class="mo_openid_checkbox_container"><?php echo mo_sl('Pocket');?>
                        ...
                        <tr>
                            <td style="width:20%">
                                ...
                                <label class="mo_openid_checkbox_container"><?php echo mo_sl('Digg');?>
                            ...
                            <td style="width:20%">
                                ...
                                <label class="mo_openid_checkbox_container"><?php echo mo_sl("Print");?>
            ...
            <tr>
                <td><b>Preview: </b><br/><span hidden id="no_apps_text"><?php echo mo_sl('No apps selected');?></span></td>
            </tr>
            ...
            <tr>
                <td>
                    <br/>
                    <p class="mo_openid_note_style"><strong>*<?php echo mo_sl('NOTE');?>:</strong><br/><?php echo mo_sl('Custom background: This will
                        change the background color of sharing icons');?>.
                        <br/><?php echo mo_sl('No background: This will change the font color of icons without background');?>.
                    </p>
                </td>
            </tr>
    ...
    <script>
        //to set heading name
        jQuery('#mo_openid_page_heading').text('<?php echo mo_sl('Social Sharing');?>');
    </script>
    <?php
    }
    ?>
