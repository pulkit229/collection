...
function mo_openid_show_apps()
{
        ...
        <tr>
            <td>
                ...
                <div class="mo_openid_highlight">
                    <h3 style="margin-left: 1%;line-height: 210%;color:white;"><?php echo mo_sl('Premium Applications');?></h3>
                </div>
    ...
    <script>
        ...
        jQuery(function() {
            var mo_openid_check_cron= "<?php echo get_option('mo_openid_rateus_activation');?>";
            var b = "<?php echo update_option('mo_openid_rateus_activation','8');?>";
                    ...
                    '<div id="cronmo_openid_support_form" class="mo-support-form" style="display: none;" >\n'+
                        ...
                        '<div ><br>\n'+
                            '<form id="cronmo_openid_rateus_submit_form" method="post" action="">\n'+
                                ...
                                '<input type="hidden" name="cronmo_openid_rateus_nonce" value="<?php echo wp_create_nonce( 'cronmo-openid-rateus-nonce' ); ?>"/>\n'+
                                '<h4 style="margin-left: 10%">We would be glad to hear what you think</h4>\n'+
                                '<input class="mo_openid_modal_rateus_style" type="email" style=" margin-left: 5%;width: 87%; border-bottom: 1px solid; border-bottom-color:#0867b2 " type="email"  required placeholder="Enter your Email" name="cronmo_openid_rateus_email" value="<?php echo get_option("mo_openid_admin_email") ?>">\n'+
